package com.yaohuaji.mr.weather;
...
public class RunJob {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileInputFormat.addInputPath(job, new Path("/root/input/weather"));
			
			Path outpath =new Path("/root/output/weather");
	...
	//key锛氭瘡琛岀涓�釜闅斿紑绗﹀乏杈逛负key锛屽彸杈逛负value
